...
public class InterfaceDao extends BaseDAO {
    ...
    public void deleteInfoRequest(int folioNum, int guestId, String command) {
        ...
        SubProParam subFolioNum = new SubProParam(new java.math.BigDecimal(
                folioNum), SubProParam.IN);
        params.add(subFolioNum);

        SubProParam subGuestId = new SubProParam(new java.math.BigDecimal(
                guestId), SubProParam.IN);
    ...
    public CMDCommon getInfoReadMessage(String command, int objId) {
        ...
        Vector params = new Vector();
        SubProParam subObjID = new SubProParam(new java.math.BigDecimal(objId),
                                               SubProParam.IN);
        SubProParam subOut = new SubProParam(new Vector(), "STRING_ARR",
                                             SubProParam.OUT);
        params.add(subObjID);
        params.add(subOut);
