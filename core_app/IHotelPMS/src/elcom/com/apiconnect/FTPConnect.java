...
public class FTPConnect {
    ...
    public boolean download(String host, String port, String username,
                            String password, String localFileName,
    ...
    /*up a file to FTP*/
    public static boolean upload(FTPClient ftp, String localFilename,
                                 String remoteFile) {
        ...
        try {
            ...
            if (up == true) {
                ...
                logger.info("Delete local file .This   " + localFile.getName() +
                            " file up success " + "\n");
            }
            ftp.logout();
            ...
            if (ftp.isConnected()) {
                try {
                    ...
                    logger.info("Not can close connect. Cause : " +
                                f.fillInStackTrace() + "\n");
                }
            }
        }
    ...
    public static FTPClient connect(String server, String port, String username,
                                    String password) {
        ...
        /*can reciever 3 pararam : usser,pass, port
         * neu ko port vao thi lay port mac dinh la 21
         */
        try {
    ...
    public static File checkExistFile(FTPClient ftp, String remoteFile,
                                      String localFile) {
        ...
        try {
            ...
            System.out.println("remoteFile=[" + remoteFile + "] is exist=" +
                               isexist);
            if (!isexist) {
                aFile.createNewFile();
                isexist = true;
    ...
    public static void copy(String fromFileName, String toFileName) throws
            IOException {
