...
public class testdemo {
    enum ValueEnum {
        checInGuest, checOutGuest, changeGuestInfo, moveGuestRoom,
        moveAllGuestRoom, recievMessage, requestMessage
    }
    ...
    public void processRecord(String aLine, String proName, int pamramNum) {
        ...
        String sqlQuery = SQLPMS.STARTPROCEDURE + SQLPMS.BODYROCEDURE +
                          SQLPMS.ENDPROCEDURE;
   ...
   public static String getPathLang(){
    ...
    public static void main(String[] arg) {
        ...
        String data ="XL|MI11|G#22|MTÔng khách này ở đến hết ngày 29/04/1.Ngày 30/4/2011 đi tour Nha Trang\r\nSau đó tặng một toure đi Hoa Đà|DA110428|TI21:27:04|RN220|";
